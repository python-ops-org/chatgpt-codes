console.log("hi");
class chatbot {
  constructor(questions, answers, options, options_answer) {
    this.options = options;
    this.questions = [...questions, ...options];
    this.answers = [...answers, ...options_answer];
...
let cb = new chatbot(questions, answers, options, options_answer);
